...
class ProductDataService {
    ...
    var getProduct = productData.init(interestCount: 1, userShowResponse: userInfo.init(name: "", phoneNumber: ""), productDetailDto: productInfo.init(certificationFailedReason: "", certificationStatus: "", hitCount: 1, id: 1, name: "", description: "", price: 1, useStatus: "", productGrade: "", salesStatus: ""))
